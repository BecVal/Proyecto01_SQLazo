...
/**
 * Tests for {@link AccountProxy}, verifying authentication enforcement, delegation behavior, notifications on failed operations, and correct handling of each account action with respect to PIN validation.
 */
class AccountProxyTest {
    ...
    /**
     * Dummy facade that suppresses fee and interest recording.
     */
    ...
    /**
     * Fake account used to track which operations are called through the proxy.
     */
    static class FakeAccount extends Account {
        ...
        FakeAccount() { super(DUMMY_CLIENT, 0.0, NOOP_STATE, ZERO_INTEREST, new DummyFacade()); }
    ...
    /**
     * Fake authenticator that tracks validation attempts and allows custom valid PINs.
     * 
     */
    ...
    class Deposit {
        ...
        /**
         * Ensures deposit delegates successfully when the PIN is correct.
         */
        @Test
        @DisplayName("Delegates to real account when PIN is valid")
        void depositDelegatesOnValidPin() {
            PrintStream orig = System.err;
            ByteArrayOutputStream err = new ByteArrayOutputStream();
            System.setErr(new PrintStream(err));

            try {
                Account real = new FakeAccount();
                PinAuthenticator auth = new FakeAuthenticator("1234");
                AccountProxy proxy = new AccountProxy((Account) real, auth);
                proxy.deposit(100.0, "1234");
        ...
        /**
         * Ensures proxy denies deposit, logs error, notifies account, and does not delegate when PIN is incorrect.
         * 
         */
        @Test
        @DisplayName("Denies, prints error, and notifies when PIN is invalid")
        void depositDeniedOnInvalidPin() {
            PrintStream orig = System.err;
            ByteArrayOutputStream err = new ByteArrayOutputStream();
            System.setErr(new PrintStream(err));
    ...
    class Withdraw {
        ...
        /**
         * 
         * Ensures withdrawal delegates when PIN is valid.
         */
        @Test

        @DisplayName("Delegates to real account when PIN is valid")
        void withdrawDelegatesOnValidPin() {
            PrintStream orig = System.err;
            ...
            try {
                Account real = new FakeAccount();
                PinAuthenticator auth = new FakeAuthenticator("0000");
                AccountProxy proxy = new AccountProxy((Account) real, auth);
                proxy.withdraw(80.0, "0000");
                FakeAccount fa = (FakeAccount) real;
        ...
        /**
         * Ensures withdrawal is denied and error is reported when PIN is invalid.
         */
        @Test
        @DisplayName("Denies, prints error, and notifies when PIN is invalid")

        void withdrawDeniedOnInvalidPin() {
            PrintStream orig = System.err;
            ByteArrayOutputStream err = new ByteArrayOutputStream();
            System.setErr(new PrintStream(err));
            ...
            try {
                ...
                Account real = new FakeAccount();
                PinAuthenticator auth = new FakeAuthenticator("ok");
                AccountProxy proxy = new AccountProxy((Account) real, auth);
                proxy.withdraw(20.0, "bad");
                FakeAccount fa = (FakeAccount) real;
                FakeAuthenticator au = (FakeAuthenticator) auth;
    ...
    class CheckBalance {
        ...
        /**
         * Ensures balance check delegates and returns correct balance when PIN is valid.
         */
        @Test
        @DisplayName("Delegates and returns balance when PIN is valid")
        void checkBalanceDelegatesOnValidPin() {
            PrintStream orig = System.err;
            ByteArrayOutputStream err = new ByteArrayOutputStream();
            ...
            try {
                ...
                FakeAccount real = new FakeAccount();

                real.balanceToReturn = 123.45;

                FakeAuthenticator auth = new FakeAuthenticator("ok");
                AccountProxy proxy = new AccountProxy(real, auth);
                double result = proxy.checkBalance("ok");
        ...
        /**
         * Ensures failed PIN causes notification, printed error, and returns -1.
         * 
         * 
         */
        @Test
        @DisplayName("Denies, prints error, notifies, and returns -1 when PIN is invalid")
        void checkBalanceDeniedOnInvalidPin() {
            PrintStream orig = System.err;
            ByteArrayOutputStream err = new ByteArrayOutputStream();
            System.setErr(new PrintStream(err));
            ...
            try {
                FakeAccount real = new FakeAccount();
                FakeAuthenticator auth = new FakeAuthenticator("good");

                AccountProxy proxy = new AccountProxy(real, auth);

                double result = proxy.checkBalance("bad");
    ...
    class ProcessMonth {
        ...
        /**
         * Ensures monthly processing is never gated by PIN validation.
         */
        @Test
        @DisplayName("Delegates directly without authentication")

        void delegatesWithoutAuth() {
            PrintStream orig = System.err;
            ByteArrayOutputStream err = new ByteArrayOutputStream();
            ...
            try {
                FakeAccount real = new FakeAccount();
                FakeAuthenticator auth = new FakeAuthenticator("irrelevant");
                AccountProxy proxy = new AccountProxy(real, auth);
