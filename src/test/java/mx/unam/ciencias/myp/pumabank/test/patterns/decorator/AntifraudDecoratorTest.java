...
/**
 * Tests for {@link AntiFraudDecorator}, verifying deposit/withdraw thresholds, hook invocation behavior, and monthly anti-fraud processing.
 */
class AntiFraudDecoratorTest {
    /**
     * Test account implementation used to record operations and hook calls.
     */
    ...
    /**
     * Test account with no hook support to validate graceful no-op behavior.
     */
    ...
    /**
     * Decorator that captures history and notification messages instead of forwarding them to the wrapped account.
     */
    ...
    class DepositBehavior {
        ...
        /**
         * Ensures deposits delegate to the underlying account.
         */
        @Test
        ...
        /**
         * Ensures hook logic is not triggered at or below the threshold.
         * 
         */
        @Test
        ...
        /**
         * 
         * Ensures suspicious deposits above the threshold trigger hooks.
         */
        @Test
    ...
    class WithdrawBehavior {
        ...
        /**
         * 
         * Ensures withdrawals delegate to the underlying account.
         */
        @Test
        ...
        /**
         * Ensures suspicious withdrawals above the threshold trigger hooks.
         */
        @Test
        @DisplayName("Triggers hooks when amount > 10000")
        void triggersHooksAboveThreshold() {
    ...
    class MonthlyProcessing {
        ...
        /**
         * Ensures monthly anti-fraud fees and notifications occur, and normal processing still delegates.
         * 
         * 
         */
        @Test
